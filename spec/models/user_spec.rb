...
RSpec.describe User, type: :model do
  ...
  it 'should return 3 recent posts' do
    ...
    post3 = Post.create(title: 'First Testing Post', text: 'fisrt testing post', comments_counter: 2, likes_counter: 1,
                        author_id: user.id)
    post4 = Post.create(title: 'First Testing Post', text: 'second testing post', comments_counter: 2,
                        likes_counter: 1, author_id: user.id)
    post5 = Post.create(title: 'First Testing Post', text: 'third testing post', comments_counter: 2, likes_counter: 1,
                        author_id: user.id)
